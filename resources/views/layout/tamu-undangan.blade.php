                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/add-tamu/{{$client}}/{{$code}}" class="btn btn-primary"><i class="icon-plus"></i></a>
                                ...
                                <table  class="table border table-striped table-bordered ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" id="copyButton" data-clipboard-text="{{ env('APP_URL') }}/undangan_unique/{{$tamu->kode}}"><i class="icon-docs"></i></button>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/update-tamu" method="POST">
