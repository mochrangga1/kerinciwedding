...
@section('container')
 ...
 <!-- ============================================================== -->
            ...
            <!-- ============================================================== -->
                ...
                <form action="/admin/add-undangan" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label for="tema">Pilih Tema</label>
                                            <div class="container">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="card card-body">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label" for="male">Hitam Klasik</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="tema" name="tema" value="2" class="custom-control-input">
                                                                <label class="custom-control-label" for="female">Putih Bunga</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="tema3" name="tema" value="3" class="custom-control-input">
                                                                <label class="custom-control-label" for="tema3">Kelabu Coklat</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="tema4" name="tema" value="4" class="custom-control-input">
                                                                <label class="custom-control-label" for="tema4">Hitam Elegan</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="card">
                                                            <div class="card-body" id="output" style="display: flex; overflow-x:auto;">
                                                                <!-- Output -->
                                                                <img src="{{asset('Undangan-Tema-1/assets/images/Tema1_1.jpeg')}}" class="img-fluid" width="200" height="200">
                                                                <img src="{{asset('Undangan-Tema-1/assets/images/Tema1_2.jpeg')}}" class="img-fluid" width="200" height="200">
                                                                <img src="{{asset('Undangan-Tema-1/assets/images/Tema1_3.jpeg')}}" class="img-fluid" width="200" height="200">
                                                            </div>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#modalUndanganBaru input[type="radio"]').click(function() {
                                                    ...
                                                    $('#output').html(``);
                                                    if (value === "1") {
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_1.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_2.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_3.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#text').html("TEMA <strong>1</strong>");
                                                    }
                                                    if (value === "2") {
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_1.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_2.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_3.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#text').html("TEMA<strong>2</strong>");
                                                    }
                                                    if (value === "3") {
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_1.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_2.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_3.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#text').html("TEMA<strong>3</strong>");
                                                    }
                                                    if (value === "4") {
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_1.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_2.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#output').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_3.jpg')}}" class="img-fluid" width="200" height="400">`);
                                                        $('#text').html("TEMA<strong>4</strong>");
                                                    }
                                                });
                                            });
                                        </script>
                ...
                <form action="/admin/update-undangan" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label for="tema">Pilih Tema</label>
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="card">
                                                            <div class="card-body" id="outputEdit" style="display: flex; overflow-x:auto;">
                                                                <!-- Output -->
                                                            </div>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#modalUndanganEdit input[name="tema"]').on('click', function() {
                                                        $('#outputEdit').html(``);
                                                    if (this.value === "1") {
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_1.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_2.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema1_3.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#textEdit').html("TEMA <strong>1</strong>");
                                                    }
                                                    if (this.value === "2") {
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_1.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_2.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema2_3.jpeg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#textEdit').html("TEMA<strong>2</strong>");
                                                    }
                                                    if (this.value === "3") {
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_1.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_2.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema3_3.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#textEdit').html("TEMA<strong>3</strong>");
                                                    }
                                                    if (this.value === "4") {
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_1.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_2.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#outputEdit').append(`<img src="{{asset('Undangan-Tema-1/assets/images/Tema4_3.jpg')}}" class="img-fluid" width="200" height="200">`);
                                                        $('#textEdit').html("TEMA<strong>4</strong>");
                                                    }
                                                });
                                            });
                                        </script>
...
<script>
    ...
    function hapusUndangan() {
        ...
        $.ajax({
            ...
            url: '/admin/delete-undangan/' + undanganId,
...
<script>
    ...
    $(document).ready(function() {
        $('#zero_config .btn-primary').on('click', function(e) {
            ...
            $('#modalUndanganEdit').parent().attr('action', '/admin/update-undangan/' + id);

            // ambil data undangan
            $.ajax({
                url: '/admin/fetch-undangan/' + id,
                type: 'GET',
                success: function(response) {
                    // perbarui form
                    ...
                    // tema
                    $('#modalUndanganEdit input[type="radio"][value="' + response.tema + '"]').click();
